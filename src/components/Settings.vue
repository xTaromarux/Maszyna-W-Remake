  ...
  <div id="settings" v-if="open">
    ...
    <div class="flexColumn">
      <div class="toggleButtonDiv" :class="{ active: lightMode }">
        <span @click="setLightMode(true)"> <SunIcon /> Light </span>
        <span @click="setLightMode(false)"> <MoonIcon /> Dark </span>
      </div>
    </div>
...
export default {
  ...
  computed: {
    /** UI labels for each extras flag */
    extrasLabels() {
      return {
