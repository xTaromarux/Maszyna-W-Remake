  ...
  "pl": {
    ...
    "aiChat": {
      ...
      "apiKey": {
        ...
        "noticeTitle": "Wazne informacje",
        "noticeRateLimits": "Ustaw limity uzycia dla tego klucza po stronie dostawcy modelu, zeby w razie problemu ograniczyc koszty i liczbe zapytan.",
        "noticeStorage": "Nie przechowujemy tego klucza na backendzie. Jest trzymany lokalnie po stronie frontendu, w tej przegladarce.",
        "noticeShare": "Nie udostepniaj tego klucza innym osobom i nie pokazuj go na screenach, streamach, nagraniach ani w publicznych repozytoriach.",
        "show": "Pokaz",
        "hide": "Ukryj",
        "save": "Zapisz klucz",
        "clear": "Usun klucz",
  ...
  "en": {
    ...
    "aiChat": {
      ...
      "apiKey": {
        ...
        "noticeRateLimits": "Set usage limits for this key in your model provider account, so you can cap costs and request volume if anything goes wrong.",
        "noticeStorage": "We do not store this key on the backend. It is kept locally on the frontend, in this browser only.",
        "noticeShare": "Do not share this key with anyone and do not expose it in screenshots, streams, recordings, or public repositories.",
        "show": "Show",
        "hide": "Hide",
        "save": "Save key",
        "clear": "Remove key",
